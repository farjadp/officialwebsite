    ...
    return (
        <div className="flex flex-col gap-12">
            ...
            <StepIn className="flex flex-col items-center gap-6 pt-4 text-center">
                <p className="text-sm text-v3-light">Your Startup Readiness Score</p>
            ...
            <StepIn delay={0.2} className="rounded-3xl border border-v3-line/80 bg-v3-raise p-7 md:p-10">
                ...
                <p className="mt-3 max-w-2xl leading-relaxed text-v3-soft rtl:leading-loose">Based on your lowest scoring areas, here is what you should focus on next to improve your readiness.</p>
                ...
                <div className="mt-10 flex flex-col gap-6 border-t border-v3-line/80 pt-8 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h4 className="text-lg font-medium text-v3-bone">Want a deeper startup review?</h4>
                        <p className="mt-1 text-sm text-v3-mute">Book a strategy session to discuss these results and get a custom roadmap.</p>
                    </div>
                    <div className="flex w-full gap-3 sm:w-auto">
                        <Link href="/contact" className={LINK_SECONDARY}>
