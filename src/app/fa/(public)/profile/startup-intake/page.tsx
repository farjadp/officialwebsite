// ============================================================================
// File Path: src/app/fa/(public)/profile/startup-intake/page.tsx
...
export default async function FaStartupIntakeDashboard() {
    ...
    return <PortalStartupIntakeList locale="fa" isPrivileged={isPrivileged} intakes={intakes} />
}
