// ============================================================================
// File Path: src/app/fa/(public)/profile/page.tsx
...
export default async function FaProfilePage() {
    ...
    return <PortalProfile locale="fa" user={user} isPrivileged={isPrivileged} />
}
