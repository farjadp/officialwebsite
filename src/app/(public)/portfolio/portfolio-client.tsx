                                                    ...
                                                    <div className="flex gap-2">
                                                        ...
                                                        {item.link && (
                                                            <a href={item.link} target="_blank" rel="noopener noreferrer"
                                                                ...
                                                                <span className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 bg-stone-800 text-xs px-2 py-1 rounded opacity-0 group-hover/link:opacity-100 transition-opacity z-10">Visit</span>
                                                            </a>
                                                        )}
                                                        <Link href={`/portfolio/${item.id}`}
                                                            ...
                                                            <span className="absolute bottom-full mb-2 right-0 bg-[#0F3F35] text-xs px-2 py-1 rounded opacity-0 group-hover/link:opacity-100 transition-opacity whitespace-nowrap z-10">Case Study</span>
                                                        </Link>
                                                    </div>
                                                </div>
                                            </div>
